...
const CreateRequest = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert("Request created successfully! (Frontend demo)");
        ...
        <div className="bg-[#FCFBF8] rounded-2xl p-6 md:p-8 shadow-sm border border-[#8C8579]/5">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t border-[#8C8579]/10">
              ...
              <button
                type="submit"
                className="flex-1 px-6 py-3 bg-[#7A2F2F] text-white rounded-xl hover:bg-[#631f1f] transition-all duration-300 shadow-sm hover:shadow-md active:scale-[0.98] font-medium text-sm flex items-center justify-center gap-2"
              >
                <Send size={18} />
                Create Request
              </button>
